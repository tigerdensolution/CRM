...
//reciving field details.
                ...
                if (trim($mobile_number) == NULL || trim($mobile_number) == "") {
                    $mobile_number = 0;
                }
...
//error exception
                    ...
                    $sql = "INSERT INTO clients_information(customer_email, customer_name, company_name, address_1, address_2, address_3, city, state, country, country_code, pincode, prifix, contact_number, mobile_number)
VALUES ('$customer_email','$customer_name','$company_name','$address_1','$address_2','$address_3','$city','$state','$country','$country_code',$pincode,$prifix,$contact_number,$mobile_number)";
                    $conn->exec($sql);
            ...
            <html>
                ...
                <body onload="document.client_detail.company_name.focus();">
                    <div class="container-fluid">
                        <div class="container">
                            <p class="top-right"><span class="h1">Enter clients details</span><span class="logout"><a href="logout.php?data"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Logout</a></span></p>
                            ...
                            <div>
                                <form name="client_detail" action="add_client.php?data" method="post" onsubmit="return validation();">
                                    <div class="tbl_domain col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="company_name" id="company_name" pattern="^([a-zA-Z\s]{3,})$" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="customer_name" id="customer_name" pattern="^([a-zA-Z\s]{3,})$" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea class="form-control" name="address_3" id="address_3" ></textarea>
                                                </td>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="city" id="city" pattern="^([a-zA-Z\s]{3,})$" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="state" id="state" pattern="^([a-zA-Z\s]{3,})$" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="country" id="country" pattern="^([a-zA-Z\s]{3,})$" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="country_code" id="country_code" value="+91" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="number" name="pincode" id="pincode" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="number" name="prifix" id="prifix" value="824" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="tel" name="mobile_number" id="mobile_number">
                                                </td>
